...
const ProjectsSection: React.FC = () => {
	const projects1 = PROJECTS_CASES.slice(0, 3)
	const projects2 = PROJECTS_CASES.slice(3, 9)
	const lastCase = PROJECTS_CASES[9]

	console.log(1, projects1)
	console.log(2, projects2)
	console.log(3, lastCase)
		...
		<section className='mb-14'>
			...
			<div className='container mx-auto md:px-10 lg:px-20'>
				<div
					...
					{projects1.map((projectCase, index) => (
						<Link
					...
					{projects2.map((projectCase, index) => (
						<Link
							className={styles.projectLink}
							key={`${projectCase.title}-${index}`}
							href='/projects/case'>
					...
					<Link
						className={styles.projectLink}
						href='/projects/case'>
						<ProjectCard projectCase={lastCase} />
					</Link>
				</div>
