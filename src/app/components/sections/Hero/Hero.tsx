...
const Hero = () => (
	<div
		className={clsx(
			styles.hero,
			'container mx-auto md:px-10 lg:px-20 relative overflow-hidden py-16 mb-10 flex flex-col items-start gap-12 justify-center md:justify-normal md:bg-none lg:gap-0 lg:flex-row lg:justify-between'
		)}>
		...
		<AnimatedWrapper
			...
			<div
				className={clsx(
					styles.background,
					'absolute left-0 right-0 bottom-0 flex flex-col justify-end items-center overflow-hidden pointer-events-none bg-no-repeat'
				)}></div>
		</AnimatedWrapper>
	</div>
)
