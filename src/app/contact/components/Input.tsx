...
const Input = ({ name, type, placeholder, formData, errors, handleChange }: InputProps) => (
	<div className='w-full sm:w-3/5 lg:w-1/2'>
		<input
			...
			className='w-full py-5 px-6 border border-dark-color rounded-none leading-5 disabled:border-dark-color/10 disabled:text-dark-color/10 focus:border-[1.5px] placeholder:text-grau-500'
		/>
