		...
		<div className='container px-4 mx-auto md:px-10 lg:px-20'>
			...
			<div className='grid gap-6 sm:grid-cols-[1fr_auto] xl:grid-cols-[66%_auto] xl:grid-rows-[auto_auto]'>
				<ImageWithSkeleton
					...
					className='block h-full shadow xl:row-span-2 min-h-48 bg-dark-color'
				/>
				...
				<p className='text-base text-gray-800 xl:self-end sm:max-xl:col-span-2 text-balance md:text-lg'>
					Nanchang Wave is a landscape based community centre with a varied program forming the
					heart of a large residential development. The double helix structure towards the wetland
					area gives 360 degrees overview of the neighbourhood as one walks up to the panoramic
					gallery at top.
				</p>
			</div>
		</div>
